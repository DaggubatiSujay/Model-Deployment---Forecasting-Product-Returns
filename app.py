...
def get_features(df):
    ...
    for subgroup, probability in subgroup_return_config.items():
        ...
        curr_subgroup = subgroup.strip()
        if curr_subgroup not in subgroups_list:
            subgroups_list.append(curr_subgroup)
    ...
    for prodline, probability in productLine_return_config.items():
        ...
        curr_productline = prodline.strip()
        if curr_productline not in productlines_list:
            productlines_list.append(curr_productline)
    ...
    return df, subgroups_list, productlines_list
...
<style>
    .reportview-container .markdown-text-container {
        padding-top: 0;  /* Reduce top padding, adjust the value as needed */
    }
